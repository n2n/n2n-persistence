...
class CommonStringColumn extends ColumnAdapter implements StringColumn {
	private $length;
	private $charset;

	public function __construct($name, $length, $charset = null) {
		parent::__construct($name);
		$this->length = doubleval($length);
	...
	public function copy($newColumnName = null) {
		...
		$newColumn = new self($newColumnName, $this->getLength(), $this->getCharset());
