...
abstract class Comparison implements SequenceItem {
	...
	public abstract function buildQueryComparison(QueryFragmentBuilder $fragmentBuilder);
	
	public abstract function isToSkip();
	
	public function getSequenceOperator() {
		return $this->sequenceOperator;
	}
	
	public function setSequenceOperator(SequenceOperator $sequenceOperator) {
