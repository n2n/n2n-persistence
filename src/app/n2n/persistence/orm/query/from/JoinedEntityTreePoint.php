...
class JoinedEntityTreePoint extends EntityTreePoint implements JoinedTreePoint {
	private $joinType = JoinType::INNER; 
	private $onQueryComparator;
	
	public function __construct(QueryState $queryState, TreePointMeta $queryPointMeta) {
		parent::__construct($queryState, $queryPointMeta);
	...
	public function apply(SelectStatementBuilder $selectBuilder) {
		$this->treePointMeta->applyAsJoin($selectBuilder, $this->joinType, $this->onQueryComparator);
