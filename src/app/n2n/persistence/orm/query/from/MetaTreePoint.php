...
interface MetaTreePoint extends TreePoint {
	/**
	...
	public function requestCustomPropertyJoinTreePoint(EntityProperty $entityProperty, 
			bool $innerJoinRequired): JoinedTreePoint;
}
